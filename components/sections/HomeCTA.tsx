          ...
          <FadeIn>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[9px] uppercase tracking-[0.14em] text-ivory/30">Est. {COMPANY.established} · Sharjah, UAE</p>
              </div>
            </div>
            ...
            <p className="body-large text-ivory/50 max-w-sm">
          ...
          <FadeIn delay={0.12}>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-1">
                <a href={`tel:${COMPANY.phone}`} className="flex-1 flex items-center gap-3 px-4 py-3 border border-ivory/15 hover:border-ivory/30 transition-colors">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="text-ivory/40">
                  ...
                  <div>
                    <p className="text-ivory text-xs font-medium">{COMPANY.phone}</p>
                    <p className="text-ivory/30 text-[10px]">Call us</p>
                  </div>
                </a>
                <a href={`mailto:${COMPANY.email}`} className="flex-1 flex items-center gap-3 px-4 py-3 border border-ivory/15 hover:border-ivory/30 transition-colors">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="text-ivory/40">
                    <path d="M1 3h12v8H1V3zm0 0l6 5 6-5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <div>
                    <p className="text-ivory text-xs font-medium truncate">{COMPANY.email}</p>
                    <p className="text-ivory/30 text-[10px]">Email us</p>
                  </div>
                </a>
              </div>
            </div>
