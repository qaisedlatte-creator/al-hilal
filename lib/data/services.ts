...
export const services: Service[] = [
  {
    ...
    metaDescription:
      "Professional offset printing for brochures, business cards, flyers, letterheads, calendars, catalogues and booklets. Sharjah, UAE.",
  },
  {
    ...
    metaDescription:
      "Digital printing for stickers, roll-ups, pop-ups, banners, acrylic signs, sign boards and window films. Fast turnaround, Sharjah UAE.",
  },
  {
    ...
    items: [
      ...
      "Momentous",
      "Custom Gift Sets",
      "Uniform Set Printing",
    ],
    image: "/images/services/corporate-gifts.jpg",
    metaTitle: "Corporate Gifts & Branded Merchandise UAE | Al Hilal",
    metaDescription:
      "Corporate gifts, sublimation printing, t-shirt printing, engraving, canvas bags, custom gift sets and uniform printing. Sharjah, UAE.",
  },
  {
    slug: "rubber-stamps",
    title: "Rubber Stamps",
    ...
    metaDescription:
      "Custom rubber stamps in UAE. Self-inking, pre-inked, date stamps, company stamps. Same-day production. Sharjah based.",
  },
  {
    ...
    metaDescription:
      "Signage and advertising production for outdoor, indoor, vehicle wraps and exhibitions across UAE. Sharjah based.",
  },
];
